...
const Reviews = () => {
  ...
  const reviewsData = [
    ...
    },
    {
      ...
      text: 'Я очень ценю возможность постоянного роста в Практикуме. Школа наставничества дала хорошую базу в преподавании, совершенствуюсь каждый день и не собираюсь останавливаться.'
    },
    {
      id: 7,
      img: photo7,
